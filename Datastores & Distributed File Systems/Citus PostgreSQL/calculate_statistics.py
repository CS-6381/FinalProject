# Ref FinalProject/Datastores & Distributed File Systems/Apache Cassandra/JamesVu_CraigTopham_ThomasBoudreau/Code/calculateStatistics.py 
...
directory = Path('./Results') # ./timeDifferences/all
